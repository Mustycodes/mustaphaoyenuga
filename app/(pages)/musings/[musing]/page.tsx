    ...
    <article className='mx-auto w-full max-w-2xl'>
      <header className='mb-4 lg:mb-6'>
        <div className='flex items-center gap-x-4'>
          <p className='text-white'>
            <time dateTime='2025-07-04' title='July 4th,, 2025'>
              July 4, 2025
            </time>
          </p>
          <div className='w-0.5 h-6 bg-white' />
          <p className='text-white'>Mustapha Oyenuga</p>
        </div>
        <h1 className='text-3xl lg:text-4xl tracking-tight font-extrabold'>
      ...
      <pre>
        <code className='language-html'>
          ...
          font-extrabold"&gt;73M+&lt;/dt&gt; &lt;dd class="text-lg font-normal
          text-gray-500 dark:text-gray-400"&gt;developers&lt;/dd&gt;
          &lt;/div&gt; &lt;div class="flex flex-col justify-center
          items-center"&gt; &lt;dt class="mb-2 text-3xl
          font-extrabold"&gt;1B+&lt;/dt&gt; &lt;dd class="text-lg font-normal
          text-gray-500 dark:text-gray-400"&gt;contributors&lt;/dd&gt;
          &lt;/div&gt; &lt;div class="flex flex-col justify-center
          items-center"&gt; &lt;dt class="mb-2 text-3xl
          font-extrabold"&gt;4M+&lt;/dt&gt; &lt;dd class="text-lg font-normal
          text-gray-500 dark:text-gray-400"&gt;organizations&lt;/dd&gt;
          &lt;/div&gt; &lt;/dl&gt;
        </code>
      </pre>
      <h4>Table example</h4>
      ...
      <p>
        ...
        usability testing, a high-fidelity prototype — with on-brand colors,
